    ...
    while true; do
        ...
        select _ in "${options[@]}"; do
            case $REPLY in
                ...
                7) ~/mdwn/commands/docker_operation.sh;;
                8) ~/mdwn/commands/apache_operation.sh;;
                9) ~/mdwn/commands/postgresql_operation.sh;;
                10) ~/mdwn/commands/microk8s_operation.sh;;
                11) ~/mdwn/commands/mdwn_updater.sh ;;
